# 세금 RAG HALF 실평가 결과 — 2026-09-13 23:12

평가 범위: holdout250 세금 **31개 시나리오·62턴**

| 통과 결과 | 시나리오 전체 통과 | 평균 응답 시간 |
| ---: | ---: | ---: |
| 40/62 (64.5%) | 17/31 (54.8%) | 11.84초 |
...
원시 결과: [세금 JSON](../../LLM/evaluation/results/tax_20260913_225946.json)
단계별 시간: [Latency 로그](../../LLM/evaluation/results/tax_latency_20260913_225946.log)
